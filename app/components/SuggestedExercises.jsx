            ...
            <div className="wrapper">
                {
                    exercises
                        ? exercises.map((exo, index) => (
                            <div key={index} className='w-full h-16 flex bg-gray-800 px-4 mb-2 rounded-lg justify-between items-center'>
                                <div className="dragIcon flex gap-2 items-center">
                                    <Image src={'/grip-vertical.svg'} alt='grab icon' width={20} height={20} className='cursor-grab' />
