...
function StepsBar() {
  ...
  return (
    <aside className='sm:w-2/6 w-full sm:h-full h-1/4 pb-16 pt-4 sm:pt-16 bg-gray-800 flex flex-col justify-start items-start sm:items-center'>
      <div className="wrapper flex sm:flex-col flex-row justify-center ">
        <div className='First-step flex sm:flex-row flex-col items-center  gap-4'>
        ...
        <div className={`sm:w-0.5 w-24 sm:h-24 h-0.5 sm:ml-6 my-4  ${pageNum === 1 ? 'bg-gray-500' : 'bg-green-400'}`}></div>
        <div className='second-step flex sm:flex-row flex-col items-center  gap-4'>
        ...
        <div className={`sm:w-0.5 w-24 sm:h-24 h-0.5 ml-6 my-4  ${pageNum <= 2 ? 'bg-gray-500' : 'bg-green-400'}`}></div>
        <div className='third-step flex sm:flex-row flex-col items-center  gap-4'>
